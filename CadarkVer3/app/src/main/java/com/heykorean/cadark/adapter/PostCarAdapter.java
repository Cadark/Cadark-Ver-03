 ...
 */
public class PostCarAdapter extends ArrayAdapter<CarListHome>{
    private ArrayList<CarListHome> arrayContact;
    private LayoutInflater inflater;


    public PostCarAdapter(Context context, int resource, ArrayList<CarListHome> objects) {
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        if (convertView == null){
            ...
            convertView = inflater.inflate(R.layout.car_post_item, null);

            holder.carName = (TextView)convertView.findViewById(R.id.nameCarPostTv);
            holder.carImage = (ImageView)convertView.findViewById(R.id.postCarImg);
            holder.topPricce = (TextView)convertView.findViewById(R.id.priceCarPostTv);
